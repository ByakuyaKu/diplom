...
namespace WebApp.AHP.BLL
{
    public class FAHPLogic : IFAHPLogic
    {
        ...
        private List<AlternativeFAHP> StartFAHP(List<CriteriaFAHP> criterias, List<AlternativeFAHP> alternatives)
        {
            ...
            result = AltFAHP(criterias, alternatives);
        ...
        static private double[,] AltFAHP(List<CriteriaFAHP> criterias, List<AlternativeFAHP> alternatives)
        {
            double[,] result = new double[criterias.Count, alternatives.Count];

            for (int i = 0; i < criterias.Count; i++)
            {
                AltMatrixToTriangular(criterias, alternatives);
                alternatives = AltSumOfRows(criterias[i].MatrixTriangularAlt, alternatives);
                alternatives = AltInverseMatrix(alternatives);
                alternatives = AltGetS(alternatives);
                alternatives = AltGetVForS(alternatives);
                alternatives = AltGetMinV(alternatives);
                alternatives = AltGetW(alternatives);
        ...
        private static List<AlternativeFAHP> AltGetW(List<AlternativeFAHP> alternatives)
        {
            double SumV = 0;
            for (int i = 0; i < alternatives.Count; i++)
        ...
        private static List<AlternativeFAHP> AltGetMinV(List<AlternativeFAHP> alternatives)
        {
            for (int i = 0; i < alternatives.Count; i++)
        ...
        private static List<AlternativeFAHP> AltGetVForS(List<AlternativeFAHP> alternatives)
        {
            for (int i = 0; i < alternatives.Count; i++)
            {
        ...
        private static List<AlternativeFAHP> AltGetS(List<AlternativeFAHP> alternatives)
        {
            for (int i = 0; i < alternatives.Count; i++)
            {
        ...
        private static List<AlternativeFAHP> AltInverseMatrix(List<AlternativeFAHP> alternatives)
        {
            double tmp = 0;
        ...
        private static List<AlternativeFAHP> AltSumOfRows(TriangularNumber[,] MatrixTriangularAlt, List<AlternativeFAHP> alternatives)
        {
            for (int i = 0; i < alternatives.Count; i++)
            {
        ...
        private static List<AlternativeFAHP> AltMatrixToTriangular(List<CriteriaFAHP> criterias, List<AlternativeFAHP> alternatives)
        {
            var SaatiTable = Saati.GetSaatiTable();
            var SaatiTableRev = Saati.GetSaatiTableReversed();
